// console.log('connec ted to maps')
...
//     if(event.target.id === 'closeDiv') mapsDiv.classList.remove('active')
// })
// async function handleGetWorldMap() {
//     const {data} = await axios.post('/maps/getWorldMap')
// }
